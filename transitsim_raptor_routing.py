...
#import trips
all_trips = pd.read_parquet(trips_dir + rf'/{taz}.parquet')

#filter
all_trips = all_trips.loc[all_trips['start_taz']==start and all_trips['end_taz']==end,:]

#run
trip_dict, metadata = one_trip(trips,impedance,raptor_settings,start_time):
